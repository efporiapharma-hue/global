...
export default function Dashboard() {
  ...
  const fetchData = async () => {
    setIsLoading(true);
    const [patientsData, invoicesData, statsData, expensesData] = await Promise.all([
  ...
  const dashboardStats = useMemo(() => {
    ...
    const showFinancials = !currentUser || ['SUPER_ADMIN', 'ACCOUNTANT'].includes(currentUser.role);
